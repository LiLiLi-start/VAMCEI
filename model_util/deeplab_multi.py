...
class ResNetMulti(nn.Module):
    def __init__(self, block, layers, num_channel, num_classes):
        # layers = [3, 4, 23, 3]
        self.inplanes = 64
...
def DeeplabMulti(num_channel, num_classes=21):
    model = ResNetMulti(Bottleneck, [3, 4, 23, 3], num_channel, num_classes)
    return model
