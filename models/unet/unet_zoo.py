...
class NestedUNet_DS(nn.Module):
    """
    Implementation of this paper:
    https://arxiv.org/pdf/1807.10165.pdf
    """
    def __init__(self, in_ch=3, out_ch=1):
        super(NestedUNet_DS, self).__init__()
        ...
        self.final_1 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
        self.final_2 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
        self.final_3 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
        self.final_4 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
    ...
    def forward(self, x):
        ...
        output_2 = self.final_2(x0_3)
        output_3 = self.final_3(x0_2)
        output_4 = self.final_4(x0_1)
        return (output_1+output_2+output_3+output_4)/4.0
        # return output_1
