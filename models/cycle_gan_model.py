...
class CycleGANModel(BaseModel):
    ...
    # def get_GAN_image(self):
    #     return {'real_A': self.real_A, 'fake_B': self.fake_B, 'rec_A': self.rec_A}
    ...
    def optimize_parameters(self):
        ...
        #         'G_A/'+name, param.clone().cpu().data.numpy(), epoch)
        #     writer.add_histogram('G_A/'+name+'/grad',
        ...
        #     writer.add_histogram(
        #         'D_A/'+name, param.clone().cpu().data.numpy(), epoch)
        #     writer.add_histogram('D_A/'+name+'/grad',
        #                          param.grad.clone().cpu().data.numpy(), epoch)
