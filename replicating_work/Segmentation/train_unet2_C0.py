...
from utils.data_loading import BasicDataset, CarvanaDataset, BasicValDataset, BasicDatasetC0, BasicDatasetValC0
from utils.dice_score import dice_loss
import matplotlib.pyplot as plt
from utils.edge_loss import edge_loss

dir_img = Path('/home/hfcui/cmr2019_data/C0LET2_nii45_for_challenge19/c0_image/')
...
dir_img_lge_val = Path('/home/hfcui/cmr2019_data/C0LET2_nii45_for_challenge19/c0_image_val/')
dir_mask_lge_val = Path('/home/hfcui/cmr2019_data/C0LET2_nii45_for_challenge19/c0gt_val/')
...
dir_checkpoint = Path('./checkpoints_unet2_c0/')
...
def train_model(
    ...
    train_set = BasicDatasetC0(dir_img, dir_mask, img_scale)

    # 创建验证集 C0
    val_set_lge = BasicDatasetValC0(dir_img_lge_val, dir_mask_lge_val, img_scale)    
    ...
    optimizer = optim.AdamW(model_2.parameters(),lr=learning_rate, weight_decay=weight_decay, foreach=True)
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                with torch.autocast(device.type if device.type != 'mps' else 'cpu', enabled=amp):
                    masks_pred_pre = model(images)
                    masks_pred = model_2(torch.cat((masks_pred_pre, images), dim=1))
...
def get_args():
    ...
    parser.add_argument('--load', '-f', type=str, default='/home/hfcui/Pytorch-UNet-master/checkpoints_unet1_lge/last.pth', help='Load model from a .pth file')
