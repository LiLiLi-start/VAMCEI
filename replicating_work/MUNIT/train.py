...
parser.add_argument('--config', type=str, default='configs/mmwhs.yaml', help='Path to the config file.')
...
while True:
    for it, (images_a, images_b) in enumerate(zip(train_loader_a, train_loader_b)):
        ...
        # plt.subplot(1, 2, 1)
        # plt.imshow(images_a[0, 0].cpu().detach().numpy())
        # plt.subplot(1, 2, 2)
        # plt.imshow(images_b[0, 0].cpu().detach().numpy())
        # plt.show()
