...
class MUNIT_Trainer(nn.Module):
    def __init__(self, hyperparameters):
        ...
        # gen_a_num = get_parameter_number(self.gen_a)
        # gen_b_num = get_parameter_number(self.gen_b)
        # dis_a_num = get_parameter_number(self.dis_a)
        # dis_b_num = get_parameter_number(self.dis_b)
        # instancenorm_num = get_parameter_number(self.instancenorm)
        # print(gen_a_num+gen_b_num+dis_a_num+dis_b_num+instancenorm_num)
